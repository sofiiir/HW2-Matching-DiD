...
*Response:* Stokes (2015) investigates whether the proposition and construction of wind turbines negatively impacts voting outcomes for political parties that support green energy construction. The unit of analysis is the differences in the voting trends for the Liberal party. The outcome based on both the fixed-effects model and the instrumental vairable model is that there is a reduction in the percent of votes that the Liberal party receives from communities with wind turbines compared to the pre-treatment voting outcomes for the Liberal party. In locations where wind turbines are proposed there is between a 4% and 8% reduction in the Liberal party's vote share. In locations where wind turbines are operational, there is between a 7% and 10% reduction in the Liberal party's vote share. The treatment group are the portions in the 26 districts of interest that have either proposed or operational wind turbines. The comparison group are the portions in the 26 districts of interest that do not have proposed or operational wind turbines. 
...
*Response:* Baseline political preferences could be correlated with communities that......
Rural areas typically have more space for development making them areas of greater interest for wind turbine development. This would also correlate with more rural communities potentially opposing wind turbine development. 
...
*Response:* The risk of spillover is addressed in this study by analyzing areas that are within a 3km radius of the proposed and operational wind turbines. This increases the number of treated groups with the paper stating that the negative effect of communities "punishing" the Liberal Party being at the upper bounds of the estimate. 
...
*Response:* The love plot clearly shows that the unadjusted covariate standardized mean differences are not within the threshold line of 0.1. Once the matching is completed the covariates adjusted standardized mean differences are within the threshold line of 0.1.
...
*Response:* Controlling for what is observable may not be enough to identify causal estimates. Confounding variables that are unobservable can be affecting the outcome of the change in liberal votes. 
...
*Response:* This analysis is focused on estimating the treatment effect for treated observations only and does not make inferences based on the full sample making it the Average Treatment for the Treated (ATT). The Average Treatment Effect (ATE) would be representative of the full sample, both treatment and control groups. 
...
*Response:* The signal here refers to the `Est` of the `beta1` while the `S.E.` of the `beta1`. Since the value is estimate is larger than double the standard error it is likely not significant. This is also supported by the `p-value` being larger than 0.05 which means it is not statistically significant.
...
*Response:* The standard error gets larger. 
...
*Response (4-6 sentences):* Proposed turbines on average result in a 4% decrease in the percent of liberal votes per precinct when compared to the percent of liberal votes in precincts when no wind turbines are proposed. Clustering by `precinct_id` is important because it clusters the standard errors
...
*Response:* More people are aware of wind turbines once they are built. When wind turbines are only proposed those individuals that are most aware about public policy are the ones that may be swayed to vote against the Liberal party. When the world can see them standing more people may have negative sentiments about the actions of the Liberal party. This phenomenon was mentioned in Stokes (2015), as it was noted that people from different precincts could potentially see these turbines from their own communities and have a similar treatment to those that live within the precinct where turbines are placed. 

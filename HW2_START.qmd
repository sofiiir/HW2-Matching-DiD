...
*Response:* A dummy variable is required to conduct a matching analysis. This variable defines whether an observation is part of the control or treatment group. 
...
*Response:* The standard error gets larger because the estimates become more conservative. The standard errors get larger to account for the increased uncertainty. 
...
*Response:* Operational turbines on average result in a 9% decrease in the percent of liberal votes per precinct when compared to the percent of liberal votes in precincts with no operational wind turbines.
